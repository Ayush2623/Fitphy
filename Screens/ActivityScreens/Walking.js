...
export default function Walking({ navigation }) {
    ...
    const stepsData = [5000, 8000, 6000, 8060, 7500, 9000, 6500]; //for week
    const dayNames = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
    const monthStepData = [5000, 7000, 6000, 9000, 4000, 8000, 10000, 5500, 7500, 6000, 8500, 7000, 6000, 9500, 4500, 7000, 8000, 6000, 7000, 8500, 9000, 6500, 8000, 5000, 6000, 7500, 8500, 9500, 7000, 8000]; // Dynamic steps data for month
                        ...
                        <View style={styles.card2}>
                            ...
                            <View style={{
                                ...
                                {selectedValue == 'Weekly' ?
                                    <BarGraph data={stepsData} dayNames={dayNames} />
                                    :
                                    <LineGraph data={monthStepData} />
                                }
                            </View>
                            {/* graph ends */}
    ...
    return (
        <View style={styles.graphContainer}>
            {data.map((value, index) => {
                const barHeight = (value / 10000) * 200; // Scale the bar height based on the maximum value (10000 steps)
